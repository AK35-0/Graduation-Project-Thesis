...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth]{CTLE Chapter img/passive CTLE.png}
        \caption{Passive CTLE circuit schematic} 
        \label{fig:passive_ctle_schematic}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{CTLE Chapter img/SD CTLE TF.png}
        \caption{Frequency response of passive CTLE}
        \label{fig:passive_ctle_response}
    \end{subfigure}
    \label{fig:passive_ctle_overview}
\end{figure}
