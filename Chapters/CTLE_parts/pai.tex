...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{CTLE Chapter img/passive_ind_assymptotic.png}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{CTLE Chapter img/passive_ind schematic.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{CTLE Chapter img/active_schematic.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{CTLE Chapter img/active_assymptotic_and_real.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{CTLE Chapter img/active pvt.png}
