...
\begin{figure}[H]
    \centering
    \includegraphics[width=.55\textwidth]{CTLE Chapter img/NC SCHEMATIC.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth]{CTLE Chapter img/nc assymptotic response.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth]{CTLE Chapter img/nc real response .png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{CTLE Chapter img/effect of inc.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{CTLE Chapter img/nc damping factor.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{CTLE Chapter img/pvt variations.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{CTLE Chapter img/nc eye diagram.png}
