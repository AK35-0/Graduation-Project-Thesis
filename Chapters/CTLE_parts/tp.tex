...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.7\textwidth]{CTLE Chapter img/idea of multipath_mid compensation.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.35\textwidth]{CTLE Chapter img/multipath block diagram.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\textwidth]{CTLE Chapter img/multipath schematic.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.4\textwidth]{CTLE Chapter img/multipath real response.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.4\textwidth]{CTLE Chapter img/multipath effect of Rmul.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.4\textwidth]{CTLE Chapter img/multipath effect of Cmul.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.4\textwidth]{CTLE Chapter img/multipath effect of w.png}
