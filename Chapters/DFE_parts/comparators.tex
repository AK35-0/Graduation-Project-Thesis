...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{DFE img/DFE_img_26.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{DFE img/DFE_img_27.png}
...
\begin{table}[ht]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{DFE img/DFE_img_28.png}
        \caption{Input common mode variation}
    \end{minipage}
\end{table}

- \textbf{Kickback Noise:} The "kickback" currents drawn from the inputs stem from several mechanisms exhibiting both differential and CM components. $V_P$ and $V_Q$ fall toward ground at unequal rates and couple to the inputs through $C_{GD1}$ and $C_{GD2}$ causing diff kickback noise. The CM kickback noise currents are much greater and occur when M7 turns on, initially drawing its drain current from $C_{GS1}$ and $C_{GS2}$, and when it turns off, with CK coupling through $C_{GD7}$ to $C_{GS1}$ and $C_{GS2}$.

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.4\textwidth]{DFE img/DFE_img_29.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.35\textwidth]{DFE img/DFE_img_30.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.4\textwidth]{DFE img/DFE_img_31.png}
    \caption{CML Latch}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.25\textwidth]{DFE img/DFE_img_32.png}
    \caption{SR Latch}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.35\textwidth]{DFE img/DFE_img_33.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{DFE img/DFE_img_34.png}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{DFE img/DFE_img_35.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{DFE img/DFE_img_36.png}
    \end{minipage}
