...
\begin{figure}[htbp] % [htbp] allows LaTeX to place the float here, top, bottom, or separate page
    ...
    \begin{minipage}[b]{0.48\textwidth} % [b] aligns the bottom of the minipages
        \centering
        \includegraphics[width=\textwidth]{DFE img/DFE_img_43.png}
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{DFE img/DFE_img_44.png}
        \par\vspace{3pt} % Adds a small vertical space between image and label
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.55\textwidth]{DFE img/DFE_img_45.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{DFE img/DFE_img_46.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{DFE img/DFE_img_47.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.3\textwidth]{DFE img/DFE_img_48.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.35\textwidth]{DFE img/DFE_img_49.png}
    \hfill
    \includegraphics[width=0.35\textwidth]{DFE img/DFE_img_50.png}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=.7\textwidth]{DFE img/DFE_img_51.png}
        \par\vspace{3pt}
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=.65\textwidth]{DFE img/DFE_img_52.png}
        \par\vspace{3pt}
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=.65\textwidth]{DFE img/DFE_img_53.png}
        \par\vspace{3pt}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.4\textwidth]{DFE img/DFE_img_54.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.55\textwidth]{DFE img/DFE_img_55.png}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \includegraphics[width=.8\textwidth]{DFE img/DFE_img_56.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=.8\textwidth]{DFE img/DFE_img_57.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{DFE img/DFE_img_58.png}
