...
\begin{equation}
    \frac{n_0}{n_1} = \frac{\int_{-\infty}^{-Vs} f_x(x)dx}{1 - \int_{-\infty}^{-Vs} f_x(x)dx}
\end{equation}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{DFE img/DFE_img_37.png}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=.7\textwidth]{DFE img/DFE_img_38.png}
        \caption{Some definitions of Sampling function \cite{johansson1998}}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=.7\textwidth]{DFE img/DFE_img_39.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{DFE img/DFE_img_40.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{DFE img/DFE_img_41.png}
...
\begin{equation}
    V(t) = \Delta V_{in} e^{\frac{t}{\tau}} \rightarrow t_d = \tau \ln\frac{V(t_d)}{\Delta V_{in}}
\end{equation}

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{DFE img/DFE_img_42.png}
