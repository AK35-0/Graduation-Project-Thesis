...
% =====================================================================
% YOUR ORIGINAL TEXT + AI ELABORATION (No new section titles)
% =====================================================================
...
% =====================================================================
% SECTION 2: STANDARD OVERVIEW (Moved from Ch 2 as per TA)
% =====================================================================
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{amr assets/pcivpcie.png} 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{amr assets/pciearc.png}
...
\begin{figure}[htbp]
    \centering
    \framebox{\includegraphics[width=0.7\textwidth]{amr assets/pam4vnrz.png}}
...
% FIGURE PLACEHOLDER: FLIT STRUCTURE
\begin{figure}[htbp]
    \centering
    \framebox{\includegraphics[width=0.8\textwidth]{amr assets/flit.png}}
    \caption[FLIT Structure]{PCIe 6.0 FLIT Structure showing TLP data, CRC, and FEC parity distribution.}
    \label{fig:flit_structure}
\end{figure}
...
\begin{itemize}
    ...
    %\item \textbf{Chapter \ref{Chapter4}} details the proposed circuit implementation of the T-Coil Input Network, VGA, and DFE.
